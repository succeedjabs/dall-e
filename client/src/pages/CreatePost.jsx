            ...
            <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-5">
                    ...
                    <FormField
                        ...
                        type="text"
                        name="prompt"
                        placeholder="A dog is running in the park"
                        value={form.prompt}
                        handleChange={handleChange}
                        isSurpriseMe
                ...
                <div className="mt-5 flex gap-5">
                    <button
                        ...
                        className="bg-green-700 text-white text-sm font-medium rounded-md sm:w-auto px-5 py-2.5 text-center">
                ...
                <div className="mt-10">
                    ...
                    <button
                        type="submit"
                        className="mt-3 text-white bg-[#6469ff] text-sm font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center"
                    >
